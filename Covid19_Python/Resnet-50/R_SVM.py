...
print("==================================================")
print("⚔️ BÜYÜK FİNAL: RESNET-50 - 5 ATLI SVM ARENASINDA ⚔️")
print("==================================================")

print("\nResNet-50 özellikleri (X) ve etiketler (y) yükleniyor...")
...
# ============================================================
# 3. YARIŞMACILARI VE SVM MOTORUNU HAZIRLAMA
# ============================================================
...
print("SVM Modelleri Eğitiliyor (Terminali takip et)...\n")
print("-" * 50)
...
for algo in algorithms:
    ...
    # SVM Modeli Kurulumu (ROC Eğrisi için probability=True zorunludur)
    clf = SVC(kernel='rbf', probability=True, random_state=42, cache_size=2000)
    
    print(f"⏳ [{algo}] SVM eğitimi başladı... (Seçilen Özellik: {num_features})")
    ...
    # Detaylı Metrikler (Ağırlıklı Ortalama)
    ...
    print(f"   -> Süre     : {train_time/60:.2f} dakika")
...
# ============================================================
print("\n==========================================================================")
print("🏆 KESİN SONUÇLAR (RESNET-50 + SVM) 🏆")
print("==========================================================================")
...
if best_model is not None:
    ...
    plt.title(f'Confusion Matrix (Champion: {best_algo} + SVM)')
    plt.ylabel('Gerçek Değerler')
    plt.xlabel('Modelin Tahmini')
    cm_path = os.path.join(work_dir, f'Best_{best_algo}_SVM_Confusion_Matrix.png')
    ...
    plt.title(f'ROC Eğrisi (Champion: {best_algo} + SVM)')
    plt.legend(loc="lower right")
    
    roc_path = os.path.join(work_dir, f'Best_{best_algo}_SVM_ROC_Curve.png')
