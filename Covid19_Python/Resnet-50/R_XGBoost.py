...
print("==================================================")
print("🌲 BÜYÜK FİNAL: RESNET-50 - 5 ATLI XGBOOST ARENASINDA 🌲")
print("==================================================")
...
# ============================================================
# 3. YARIŞMACILARI VE XGBOOST MOTORUNU HAZIRLAMA
# ============================================================
...
print("XGBoost Modelleri Eğitiliyor (Terminali takip et)...\n")
print("-" * 50)
...
for algo in algorithms:
    ...
    # XGBoost Modeli Kurulumu (Çok sınıflı, hızlı histogram metodu)
    ...
    print(f"⏳ [{algo}] XGBoost eğitimi başladı... (Seçilen Özellik: {num_features})")
...
# ============================================================
print("\n==========================================================================")
print("🏆 KESİN SONUÇLAR (RESNET-50 + XGBOOST) 🏆")
print("==========================================================================")
...
if best_model is not None:
    ...
    plt.title(f'Confusion Matrix (Champion: {best_algo} + XGBoost)')
    plt.ylabel('Gerçek Değerler')
    plt.xlabel('Modelin Tahmini')
    cm_path = os.path.join(work_dir, f'Best_{best_algo}_XGBoost_Confusion_Matrix.png')
    ...
    plt.title(f'ROC Eğrisi (Champion: {best_algo} + XGBoost)')
    plt.legend(loc="lower right")
    
    roc_path = os.path.join(work_dir, f'Best_{best_algo}_XGBoost_ROC_Curve.png')
