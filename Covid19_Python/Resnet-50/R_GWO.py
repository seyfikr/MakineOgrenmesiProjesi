...
print("==================================================")
print("🐺 GWO (GRİ KURT) RESNET-50 ÖZELLİK SEÇİMİ 🐺")
print("==================================================")
...
for t in range(max_iter):
    ...
    # 1. Kurtların Uygunluğunu Ölç ve Liderleri Seç
    ...
    # --------------------------------------------------------
    # 2. Kurtların Pozisyonunu Güncelle (Avı Kuşatma)
    # --------------------------------------------------------
    a = 2 - t * (2 / max_iter)  
    ...
    for i in range(num_wolves):
        for j in range(num_features):
            ...
            # Değeri 0-1 arasına sıkıştırıp Binary (0 veya 1) yapıyoruz
...
print(f"Orijinal 2048 özellikten, en keskin {len(best_features_indices)} özellik seçildi.")
