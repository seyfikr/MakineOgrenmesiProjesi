...
print("==================================================================")
print("🏆 BÜYÜK FİNAL: SIZINTISIZ PSO + FINE-TUNED DENSENET + LIGHTGBM 🏆")
print("==================================================================")

print("\nUzman (Fine-Tuned) özellikler diskten okunuyor...")
# DİKKAT: PyTorch'tan çıkan YENİ dosyaları okuyoruz!
...
print(f"📚 Eğitim (Train)     : {X_train.shape[0]} resim (%70)")
print(f"📝 Doğrulama (Val)    : {X_val.shape[0]} resim (%15)")
...
# ============================================================
# 4. FİTNESS FONKSİYONU (SADECE VALİDATİON İLE)
# ============================================================
...
print(f"🦅 Sürü Havalanıyor: {num_particles} Kuş, Maksimum {max_iter} Tur (Hedef: Sadece Doğrulama Seti)")
...
save_path = os.path.join(work_dir, 'PSO_Best_Features_Finetuned.npy')
...
plt.title(f'Confusion Matrix (Finetuned DenseNet + PSO + LightGBM)\nAccuracy: %{test_acc*100:.2f}')
plt.ylabel('Gerçek Değerler')
plt.xlabel('Modelin Tahmini')
plt.savefig(os.path.join(work_dir, 'Final_Finetuned_Confusion_Matrix.png'), bbox_inches='tight')
plt.close()
...
plt.title('ROC Eğrisi (Finetuned DenseNet + PSO + LightGBM)')
plt.legend(loc="lower right")
plt.savefig(os.path.join(work_dir, 'Final_Finetuned_ROC_Curve.png'), bbox_inches='tight')
plt.close()
