...
print("==================================================")
print("⚔️ BÜYÜK FİNAL: EFFICIENTNET - 5 ATLI SVM ARENASINDA ⚔️")
print("==================================================")
...
for algo in algorithms:
    ...
    # SVM Modeli Kurulumu (ROC Eğrisi için probability=True)
    ...
    # Detaylı Metrikler (Accuracy, Recall, F1-Score)
...
# ============================================================
print("\n==========================================================================")
print("🏆 KESİN SONUÇLAR (EFFICIENTNET + SVM) 🏆")
print("==========================================================================")
