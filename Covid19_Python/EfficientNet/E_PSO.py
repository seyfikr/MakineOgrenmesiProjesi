...
print("==================================================")
print("🐦 PSO (KUŞ SÜRÜSÜ) EFFICIENTNET ÖZELLİK SEÇİMİ 🐦")
print("==================================================")
...
# ============================================================
# 2. PSO PARAMETRELERİ (10 Kuş, 10 Tur, 4 Erken Durdurma)
# ============================================================
num_particles = 10
max_iter = 10
patience_limit = 4  
...
# Kuşların Başlangıç Pozisyonları ve Hızları
...
print(f"Orijinal 1280 özellikten, {len(best_features_indices)} özellik seçildi.")
