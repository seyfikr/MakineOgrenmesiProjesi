...
print("==================================================")
print("⚔️ BÜYÜK FİNAL: 5 ATLI SVM ARENASINDA KAPIŞIYOR ⚔️")
print("==================================================")

print("\nTüm özellikler (X) ve etiketler (y) yükleniyor...")
...
for algo in algorithms:
    ...
    # ----------------------------------------
    # YENİ EKLENEN DETAYLI METRİKLER
    # ----------------------------------------
    ...
    # En iyiyi belirle (Öncelik Accuracy, eşitlikte F1-Score)
...
# ============================================================
print("\n==========================================================================")
print("🏆 KESİN SONUÇLAR (SVM - RBF KERNEL) 🏆")
print("==========================================================================")
